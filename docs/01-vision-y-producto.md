...
2. **Mejorar la calidad del acompanamiento** con el **ICA** (indice ponderado, accionable).
...
| Calidad accionable | % de TL/Tutores con **ICA** calculado (datos suficientes) | >= 70 % |
...
- **Para el Admin (Jefe de TL/tutores):** panel con **ICA**, tendencias y **resumenes IA** para decidir.
